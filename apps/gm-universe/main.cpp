// gm-universe: Point-in-time universe construction (ADR-001)
//
...
gm::VoidResult run_gm_universe(const gm::Config& /*config*/, const std::filesystem::path& output_dir,
    ...
    std::filesystem::path stub_path = output_dir / "gm-universe.stub.json";
...
int main(int argc, char** argv) {
    return gm::run_stage_main(argc, argv, "gm-universe", run_gm_universe);
}
